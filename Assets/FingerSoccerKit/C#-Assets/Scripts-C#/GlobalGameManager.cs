...
public class GlobalGameManager : MonoBehaviour
{
	...
	*/
    ...
    public Texture2D[] statusModes_Fa;
    ...
    void Awake()
    {
        player1Name = LocalizationManager.GetTermTranslation("UI.GamePlay.Player1");
        player2Name = LocalizationManager.GetTermTranslation("UI.GamePlay.Player2");
        cpuName = LocalizationManager.GetTermTranslation("UI.GamePlay.Cpu");
        ...
        if (gameMode == 0)
        {
            if (playerGoals > goalLimit || playerGoals > opponentGoals)
            {
                ...
                if (LocalizationManager.CurrentLanguage == "English")
                    ...
                    statusTextureObject.GetComponent<Renderer>().material.mainTexture = statusModes_Fa[0];
            ...
            else if (opponentGoals > goalLimit || opponentGoals > playerGoals)
            {
                ...
                if (LocalizationManager.CurrentLanguage == "English")
                    ...
                    statusTextureObject.GetComponent<Renderer>().material.mainTexture = statusModes_Fa[1];
            ...
            else if (opponentGoals == playerGoals)
            {
                ...
                if (LocalizationManager.CurrentLanguage == "English")
                    ...
                    statusTextureObject.GetComponent<Renderer>().material.mainTexture = statusModes_Fa[4];
        ...
        else if (gameMode == 1)
        {
            if (playerGoals > opponentGoals)
            {
                ...
                if (LocalizationManager.CurrentLanguage == "English")
                    ...
                    statusTextureObject.GetComponent<Renderer>().material.mainTexture = statusModes_Fa[2];
            }
            ...
            else if (playerGoals < opponentGoals)
            {
                ...
                if (LocalizationManager.CurrentLanguage == "English")
                    ...
                    statusTextureObject.GetComponent<Renderer>().material.mainTexture = statusModes_Fa[3];
            }
        }
    ...
    public void OnLocalizeGameplayText()
    {
        player1Name = LocalizationManager.GetTermTranslation("UI.GamePlay.Player1");
        player2Name = LocalizationManager.GetTermTranslation("UI.GamePlay.Player2");
        cpuName = LocalizationManager.GetTermTranslation("UI.GamePlay.Cpu");
