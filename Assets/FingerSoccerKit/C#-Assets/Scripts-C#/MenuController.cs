...
public class MenuController : MonoBehaviour
{
    ...
    public GameObject GameLanugageButton;
    ...
    void Awake()
    {
        ...
        {
            GameLanugageButton.GetComponent<MeshRenderer>().materials[0].SetTexture("_MainTex", img_EnglishLanguage);
        }
        else
        {
            GameLanugageButton.GetComponent<MeshRenderer>().materials[0].SetTexture("_MainTex", img_PersianLanguage);
        }
    }
    ...
    public void GameTitleLacalization()
    {
        if (LocalizationManager.CurrentLanguage == "English")
        {
            ...
            Achievement.characterSize = 0.55f;
        }
        else
        {
            GameTitle.SetTexture("_MainTex", GameTitleFa);
            Achievement.characterSize = 0.7f;
        }
    }
}